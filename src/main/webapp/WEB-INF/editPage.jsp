			...
			<div class="row d-flex">
				<div class="col col-5 gap-2 d-flex flex-column justify-content-center">
					<div class="card p-3 border-0 rounded-4 bg-warning-subtle bg-gradient shadow">
						<form:form action="/taggedfavorites/${mediaId}/update" method="post" modelAttribute="editedMedia">
							...
							<br />
							<br />
							<p>This is where the Tag lists will be later...</p>
							<br />
							<br />
							<br />
							<br />
							...
							<div class="d-flex justify-content-end gap-2">
								<a class="btn btn-secondary shadow" href="<c:out value="/taggedfavorites/${mediaId}/edit"/>">Reset</a>
